...
def upload_pic():
    ...
    profile_picture = filedialog.askopenfilename(initialdir="./", title="Select a File",
...
def manager_upload_iris1():
    ...
    manager_iris_image1 = filedialog.askopenfilename(initialdir="./", title="Select a File",
                                                     filetypes=(("JPG files", "*.JPG*"), ("all files", "*.*")))
...
def manager_upload_iris2():
    ...
    manager_iris_image2 = filedialog.askopenfilename(initialdir="./", title="Select a File",
                                                     filetypes=(("JPG files", "*.JPG*"), ("all files", "*.*")))
...
def customer_upload_iris1():
    ...
    customer_iris_image1 = filedialog.askopenfilename(initialdir="./", title="Select a File",
                                                      filetypes=(("JPG files", "*.JPG*"), ("all files", "*.*")))
...
def customer_upload_iris2():
    ...
    customer_iris_image2 = filedialog.askopenfilename(initialdir="./", title="Select a File",
                                                      filetypes=(("JPG files", "*.JPG*"), ("all files", "*.*")))
    ...
    if manager_name_entry.get() == '' or manager_cnic_entry.get() == '' or manager_iris_image1 == '':
        ...
        if yes:
            ...
            if messagebox.showinfo('Info', 'Your account has been created! \n Please Log In.'):
                db.write(manager_name_entry.get(), manager_cnic_entry.get(), recognize_iris(manager_iris_image1),
                         recognize_iris(manager_iris_image2))
                raise_frame(home)
...
def login_manager_iris_upload():
    ...
    login_manager_iris = filedialog.askopenfilename(initialdir="./", title="Select a File",
                                                    filetypes=(("JPG files", "*.JPG*"), ("all files", "*.*")))
...
def login_customer_iris_upload():
    ...
    login_customer_iris = filedialog.askopenfilename(initialdir="./", title="Select a File",
                                                     filetypes=(("JPG files", "*.JPG*"), ("all files", "*.*")))
...
def login_customer():
    ...
    if login_customer_iris != '':
        ...
        if check:
            ...
            customer_locker_num.configure(
                text='Locker number: ' + str(data[manager_customer]['customers'][customer]['locker']) + ' ')
...
Button(home, text="login Bank Manager", width=20, height=2, font=("Courier", 20),
       command=lambda: raise_frame(manager_login)).pack(pady=10)
Button(home, text="Register Bank Manager", width=20, height=2, font=("Courier", 20),
       command=lambda: raise_frame(manager_register)).pack(pady=10)
...
Button(manager_login, text='Please use iris image', font=("Courier", 20), command=login_manager_iris_upload).pack(
    pady=10)
...
iris_img1 = Button(manager_register, height=1, text='Select', font=('Courier', 20), command=manager_upload_iris1).place(
    x=100, y=340)
...
manageriris_img2 = Button(manager_register, height=1, text='Select', font=('Courier', 20),
                          command=manager_upload_iris2).place(x=100, y=420)
...
Button(manager_page, text='Login Locker User', width=20, height=2, font=("Courier", 20),
       command=lambda: raise_frame(customer_login)).place(x=150, y=300)
Button(manager_page, text='Register Locker User', width=20, height=2, font=("Courier", 20),
       command=lambda: raise_frame(customer_register)).place(x=150, y=400)
...
customer_iris_img1 = Button(customer_register, height=1, text='Select', font=('Courier', 20),
                            command=customer_upload_iris1).place(x=100, y=370)
...
customer_iris_img2 = Button(customer_register, height=1, text='Select', font=('Courier', 20),
                            command=customer_upload_iris2).place(x=100, y=445)
customer_iris2_label = Label(customer_register, text='', font=("Courier", 12), )
customer_iris2_label.place(x=225, y=450)

Button(customer_register, text='Back', font=("Courier", 20), command=lambda: raise_frame(manager_page)).place(x=100,
                                                                                                              y=600)
...
Button(customer_login, text='Please use iris image', font=("Courier", 20), command=login_customer_iris_upload).place(
    x=175, y=200)
